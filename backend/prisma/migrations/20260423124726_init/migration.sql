...
-- CreateIndex
CREATE UNIQUE INDEX "SessionMember_userId_roomId_key" ON "SessionMember"("userId", "roomId");
...
-- AddForeignKey
ALTER TABLE "SessionMember" ADD CONSTRAINT "SessionMember_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "Room"("id") ON DELETE CASCADE ON UPDATE CASCADE;
