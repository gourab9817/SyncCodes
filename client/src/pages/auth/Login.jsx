    ...
    <div style={{
      ...
      <div className="animate-fade-in" style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--text3)', fontSize: 14 }}>Sign in to your SyncCodes account</p>
        </div>
        ...
        <div className="sc-card" style={{ padding: 32 }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              <label htmlFor="login-email" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--text2)', marginBottom: 6 }}>Email</label>
              <input
                id="login-email"
                className="sc-input"
                type="email"
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                <label htmlFor="login-password" style={{ fontSize: 13, fontWeight: 600, color: 'var(--text2)' }}>Password</label>
                <Link to="/forgot-password" style={{ fontSize: 12, color: 'var(--coral)', textDecoration: 'none' }}>Forgot password?</Link>
              </div>
              <input
                id="login-password"
                className="sc-input"
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 14, color: 'var(--text3)' }}>
          ...
          <Link to="/register" style={{ color: 'var(--coral)', fontWeight: 600, textDecoration: 'none' }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
